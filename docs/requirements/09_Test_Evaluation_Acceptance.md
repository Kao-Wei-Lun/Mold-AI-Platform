...
| CADSIM-MIG-001..004 | Qdrant CAD v2 migration/alias/rollback | T-CADSIM-MIG-01, T-CADSIM-RBK-01 | cad-v1-v2-migration-v1 | `stage-46a-cad-v2-read-migration.md`, `stage-46c-cpu-ai-release-gate.md` | Platform Owner | Implemented; observation-period deletion remains prohibited |
...
| RAG-MIG-001..003 | Knowledge v2 reindex/alias/rollback | T-RAG-MIG-01, T-RAG-RBK-01 | knowledge-v1-v2-migration-v1 | `stage-46b-knowledge-v2-migration.md`, `stage-46c-cpu-ai-release-gate.md` | Platform Owner | Implemented; observation-period deletion remains prohibited |
| CADSIM-ACC-001..003, RAG-ACC-001..004 | Layered evaluation and phase gates | T-AI-V2-GATE-01 | governed-ai-v2-benchmark-v1 | `stage-46c-cpu-ai-release-gate.md` | QA + Domain Owner | Structural gate implemented; expert Golden quality approval pending |
