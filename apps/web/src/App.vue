  ...
  <div class="app-shell">
    ...
    <main class="workspace">
      <header class="hero">
        ...
        <h1>CAD engineering workspace</h1>
        <p>
          Upload a versioned STEP or STL artifact, follow its asynchronous CAD job, and inspect
          geometry evidence generated by the isolated worker.
        </p>
      </header>
