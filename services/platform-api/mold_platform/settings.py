...
SIMILARITY_COARSE_CANDIDATES = int(os.getenv("SIMILARITY_COARSE_CANDIDATES", "100"))
SIMILARITY_FINE_CANDIDATES = int(os.getenv("SIMILARITY_FINE_CANDIDATES", "20"))
SIMILARITY_SURFACE_BUDGET_SECONDS = float(os.getenv("SIMILARITY_SURFACE_BUDGET_SECONDS", "30"))
...
DOCLING_CPU_ENABLED = os.getenv("DOCLING_CPU_ENABLED", "true").lower() == "true"
DOCLING_REQUIRED = os.getenv("DOCLING_REQUIRED", "false").lower() == "true"
DOCLING_MAX_PAGES = int(os.getenv("DOCLING_MAX_PAGES", "200"))
...
QDRANT_CAD_MIGRATION_ALIAS = os.getenv("QDRANT_CAD_MIGRATION_ALIAS", "cad-similarity-migration")
QDRANT_KNOWLEDGE_MIGRATION_ALIAS = os.getenv(
    "QDRANT_KNOWLEDGE_MIGRATION_ALIAS", "knowledge-text-migration"
)
CPU_AI_RELEASE_ROUTE = os.getenv("CPU_AI_RELEASE_ROUTE", "v1").lower()
KNOWLEDGE_V2_SHADOW_INDEX = os.getenv("KNOWLEDGE_V2_SHADOW_INDEX", "false").lower() == "true"
KNOWLEDGE_INDEX_READ_VERSION = os.getenv("KNOWLEDGE_INDEX_READ_VERSION", CPU_AI_RELEASE_ROUTE)
...
SIMILARITY_INDEX_READ_VERSION = os.getenv(
    "SIMILARITY_INDEX_READ_VERSION", CPU_AI_RELEASE_ROUTE
).lower()
SIMILARITY_AUTO_INDEX = os.getenv("SIMILARITY_AUTO_INDEX", "false").lower() == "true"
SIMILARITY_V2_SHADOW_INDEX = os.getenv("SIMILARITY_V2_SHADOW_INDEX", "false").lower() == "true"
